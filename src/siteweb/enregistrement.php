    ...
    //Vérification du mot de passe
        ...
        if ($stmt->execute()) {
            ...
            *{
            ...
            <a href="https://meetevent.alwaysdata.net/activation.php?token=' . $token . '&email='. $_POST['email'] .'"><button>Activer mon compte</button></a>
            </body>
            </html>
            ';
            ...
            if (!$mail_sent) {
                ...
                echo "<div style='display:flex;justify-content:center;margin-top:3%;'><div style='font-size:3vw;font-weight:bold;font-family: Poppins, sans-serif;'>Veuillez vérifier votre adresse mail sur <span style='color:#6040fe;'>". $_POST['email']."</span></div></div>";
            }
